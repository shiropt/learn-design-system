...
export type Props = {
  ...
  isLink?: boolean;
  children: ReactNode;
  appearance: "primary" | "primaryOutline" | "secondary" | "secondaryOutline" | "tertiary" | "outline";
  isDisabled?: boolean;
